...
## The contact form and Cal.com bookings
...
- `POST /api/demo` — `script.js` posts the contact form here as FormData: `name`, `email`,
  `message` (plus the `_gotcha` honeypot, which must be empty).
