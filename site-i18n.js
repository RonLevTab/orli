...
(function () {
  ...
  var HE = {
    ...
    'mock.badge1': '✓ נכתב ל‑Optima',
    'mock.badge2': '🔒 הסיסמאות לא עוזבות את השרת',
    ...
    'scrolly.0.idx': '01 · בחירה',
    'scrolly.0.h': 'בחירת טיפול',
    'scrolly.0.p': 'המטופל נכנס לאתר שלכם ובוחר טיפול אצל המטפל הנכון. הרשימה מגיעה חי מ‑Optima.',
    'scrolly.1.idx': '02 · תאריך',
    'scrolly.1.h': 'בחירת יום',
    'scrolly.1.p': 'Orli מציגה רק ימים עם זמינות אמיתית, לפי השעות והימים החופשיים של כל רופא, כך שזו אף פעם לא שעה שאינה באמת פנויה.',
    'scrolly.2.idx': '03 · שעה',
    'scrolly.2.h': 'בחירת שעה',
    'scrolly.2.p': 'השעות הפנויות לאותו יום מופיעות מיד, ישירות מהיומן החי.',
    'scrolly.3.idx': '04 · פרטים',
    'scrolly.3.h': 'מי קובע את התור',
    'scrolly.3.p': 'שם וטלפון, פעם אחת. מספר הטלפון הוא כל הזיהוי שצריך, אז אין חשבון לפתוח ואין מה לזכור.',
    'scrolly.4.idx': '05 · אימות',
    'scrolly.4.h': 'אימות בקוד',
    'scrolly.4.p': 'קוד מהיר מאמת את המטופל ממש לפני ש‑Orli קובעת משהו. זה חוסם ספאם וזה המקום שבו נאספת ההסכמה.',
    'scrolly.5.idx': '06 · נקבע',
    'scrolly.5.h': 'נכתב ל‑Optima',
